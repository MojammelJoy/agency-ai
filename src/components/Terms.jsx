...
const Terms = () => {
    ...
    return (
            ...
            <div className='flex flex-col items-center gap-5 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text-white'>
                <Title title='Meet the team'></Title>
                <Title desc='A passionate team of digital experts dedicated to your brands success'></Title>
